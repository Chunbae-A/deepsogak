      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryMetrics}>
            <View style={styles.metric}>
              ...
              <Text style={[styles.metricValue, styles.metricGreen]}>1장</Text>
            </View>
            <View style={styles.metric}>
              <Text style={[styles.metricLabel, styles.metricBlue]}>노출 후보</Text>
              <Text style={[styles.metricValue, styles.metricBlue]}>6건</Text>
            </View>
            <View style={styles.metric}>
              <Text style={styles.metricLabel}>신고자료</Text>
              <Text style={styles.metricValue}>0건</Text>
            </View>
          </View>
        </View>
        ...
        <Pressable style={styles.activityCard} onPress={onOpenMonitoring}>
          <View>
            ...
            <Text style={styles.activityBody}>후보 6건 · 최근 확인 14:32</Text>
          </View>
          <StatusChip label="확인 필요" />
        </Pressable>
      </ScrollView>

      <View style={styles.bottomCta}>
        <Text style={styles.bottomHint}>최근 공개 영역 확인 · 2분 전</Text>
